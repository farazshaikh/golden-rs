...
### Task 7: EVRFSecurity.lean -- SCAFFOLDED (5 items, 3 sorry)

| Item                               | Status                                                         |
| ---------------------------------- | -------------------------------------------------------------- |
| `advantage` + `advantage_triangle` | Defined; triangle inequality uses sorry                        |
...
| --- | ----------------- | -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------- | ----------------------------------------- | ---------- |
| S1  | EVRFSecurity.lean | `advantage_triangle`       | Triangle inequality for game-hop composition: `\|p0-p2\| ≤ \|p0-p1\| + \|p1-p2\|`                                                                                                             | Find and apply Mathlib's `abs_sub_le` or `dist_triangle` with correct argument order and coercions                                                                                                                                                                                                                                                                                                           | Trivial                           | Low                                       | ~30 min    |
