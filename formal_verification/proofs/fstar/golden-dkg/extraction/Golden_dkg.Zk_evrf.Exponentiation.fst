module Golden_dkg.Zk_evrf.Exponentiation
  ...
  | Core_models.Result.Result_Ok hoist17 ->
    (match
      ...
      | Core_models.Result.Result_Ok hoist16 ->
        Core_models.Result.Result_Ok ({ f_x = hoist17; f_y = hoist16 } <: t_PointVar)
        <:
        Core_models.Result.t_Result t_PointVar Ark_relations.R1cs.Error.t_SynthesisError
  ...
  | Core_models.Result.Result_Ok hoist20 ->
    (match
        ...
        Core_models.Result.t_Result
          ...
          Ark_relations.R1cs.Error.t_SynthesisError
      with
      | Core_models.Result.Result_Ok hoist19 ->
        Core_models.Result.Result_Ok ({ f_x = hoist20; f_y = hoist19 } <: t_PointVar)
        <:
        Core_models.Result.t_Result t_PointVar Ark_relations.R1cs.Error.t_SynthesisError
      | Core_models.Result.Result_Err err ->
        Core_models.Result.Result_Err err
