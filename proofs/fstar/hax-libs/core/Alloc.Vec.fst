...
/// IntoIterator for Vec<T, A> -- needed for `for x in vec` patterns.
[@@ FStar.Tactics.Typeclasses.tcinstance]
assume val impl_into_iter_vec (#v_T: Type0) (#v_A: Type0)
  : Core_models.Iter.Traits.Collect.t_IntoIterator (t_Vec v_T v_A)

/// Index instances for Vec (by usize, Range, RangeFull).
[@@ FStar.Tactics.Typeclasses.tcinstance]
assume val impl_index_vec_usize (#v_T #v_A: Type0)
  : Core_models.Ops.Index.t_Index (t_Vec v_T v_A) Rust_primitives.Integers.usize

[@@ FStar.Tactics.Typeclasses.tcinstance]
assume val impl_index_vec_range (#v_T #v_A: Type0)
  : Core_models.Ops.Index.t_Index (t_Vec v_T v_A) (Core_models.Ops.Range.t_Range Rust_primitives.Integers.usize)

[@@ FStar.Tactics.Typeclasses.tcinstance]
assume val impl_index_vec_range_from (#v_T #v_A: Type0)
  : Core_models.Ops.Index.t_Index (t_Vec v_T v_A) (Core_models.Ops.Range.t_RangeFrom Rust_primitives.Integers.usize)

[@@ FStar.Tactics.Typeclasses.tcinstance]
assume val impl_index_vec_range_to (#v_T #v_A: Type0)
  : Core_models.Ops.Index.t_Index (t_Vec v_T v_A) (Core_models.Ops.Range.t_RangeTo Rust_primitives.Integers.usize)

[@@ FStar.Tactics.Typeclasses.tcinstance]
assume val impl_index_vec_range_full (#v_T #v_A: Type0)
  : Core_models.Ops.Index.t_Index (t_Vec v_T v_A) Core_models.Ops.Range.t_RangeFull
