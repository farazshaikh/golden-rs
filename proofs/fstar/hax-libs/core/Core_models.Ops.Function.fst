...
/// t_Fn instance for 1-arg dependent arrows (chained from fnonce_arrow_binder).
/// Needed by f_call when higher-order functions are passed as parameters.
unfold instance fn_arrow_binder t u
  : t_Fn (_:t -> u) t = {
    _super_i0 = fnonce_arrow_binder t u;
    f_call_pre = (fun _ _ -> true);
    f_call_post = (fun (x0: (_:t -> u)) (x1: t) (res: u) -> true);
