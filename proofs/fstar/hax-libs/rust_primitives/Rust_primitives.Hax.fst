...
/// Rust trait objects: `dyn Trait` becomes `dyn n (fun z -> Trait z)`.
/// Modeled as an opaque type -- the actual vtable dispatch is not relevant for verification.
assume val dyn (#v_A: Type) (_n: v_A) (#v_B: Type) (_f: v_B) : Type0
