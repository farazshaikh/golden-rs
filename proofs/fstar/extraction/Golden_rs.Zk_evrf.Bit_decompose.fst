...
let bit_decompose
      (cs: Golden_rs.Zk_evrf.Nonnative.t_ConstraintSystem)
      (value:
      ...
      (lambda: usize)
    : (Golden_rs.Zk_evrf.Nonnative.t_ConstraintSystem & t_BitDecomposition) =
  ...
  in
  let (tmp0: Golden_rs.Zk_evrf.Nonnative.t_ConstraintSystem), (out: usize) =
    Golden_rs.Zk_evrf.Nonnative.impl_ConstraintSystem__alloc_witness cs value
  in
  let cs:Golden_rs.Zk_evrf.Nonnative.t_ConstraintSystem = tmp0 in
  ...
  (cs: Golden_rs.Zk_evrf.Nonnative.t_ConstraintSystem) =
    Core_models.Iter.Traits.Iterator.f_fold (Core_models.Iter.Traits.Collect.f_into_iter #(Core_models.Ops.Range.t_RangeInclusive
      ...
      (bits, cs
        <:
        (Alloc.Vec.t_Vec usize Alloc.Alloc.t_Global & Golden_rs.Zk_evrf.Nonnative.t_ConstraintSystem
        ))
      (fun temp_0_ i ->
          let
          (bits: Alloc.Vec.t_Vec usize Alloc.Alloc.t_Global),
          ...
          in
          let (tmp0: Golden_rs.Zk_evrf.Nonnative.t_ConstraintSystem), (out: usize) =
            Golden_rs.Zk_evrf.Nonnative.impl_ConstraintSystem__alloc_witness cs bit_val
          in
          let cs:Golden_rs.Zk_evrf.Nonnative.t_ConstraintSystem = tmp0 in
          let bit_var:usize = out in
          let cs:Golden_rs.Zk_evrf.Nonnative.t_ConstraintSystem =
            Golden_rs.Zk_evrf.Nonnative.impl_ConstraintSystem__constrain cs
          ...
          (Alloc.Vec.t_Vec usize Alloc.Alloc.t_Global &
            Golden_rs.Zk_evrf.Nonnative.t_ConstraintSystem))
  in
  ...
  in
  cs, hax_temp_output <: (Golden_rs.Zk_evrf.Nonnative.t_ConstraintSystem & t_BitDecomposition)
