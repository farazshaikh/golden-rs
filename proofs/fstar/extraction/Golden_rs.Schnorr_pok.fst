...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl: Borsh.Ser.t_BorshSerialize t_SchnorrPoK =
  {
    f_serialize_pre
    =
    (fun
    ...
    fun
      ...
      match
        Core_models.Result.impl__map_err #Prims.unit
          ...
          #(Ark_serialize.Error.t_SerializationError -> Std.Io.Error.t_Error)
          (Rust_primitives.Hax.failure "The mutation of this &mut is not allowed here.\n\nThis is discussed in issue https://github.com/hacspec/hax/issues/420.\nPlease upvote or comment this issue if you see this error message.\nNote: the error was labeled with context `DirectAndMut`.\n"
              "ark_serialize::f_serialize_compressed::<\n &mut alloc::vec::t_Vec<int, alloc::alloc::t_Global>,\n >(&(proj_golden_rs::schnorr_pok::f_commitment(deref(self))), &mut (buf))"

            <:
            Core_models.Result.t_Result Prims.unit Ark_serialize.Error.t_SerializationError)
          (fun e ->
              let e:Ark_serialize.Error.t_SerializationError = e in
              Std.Io.Error.impl_Error__other #Alloc.String.t_String
                (Alloc.String.f_to_string #Ark_serialize.Error.t_SerializationError
                    #FStar.Tactics.Typeclasses.solve
                    e
                  <:
          ...
          | Core_models.Result.Result_Ok _ ->
            ...
            (match
                Core_models.Result.impl__map_err #Prims.unit
                  ...
                  #(Ark_serialize.Error.t_SerializationError -> Std.Io.Error.t_Error)
                  (Rust_primitives.Hax.failure "The mutation of this &mut is not allowed here.\n\nThis is discussed in issue https://github.com/hacspec/hax/issues/420.\nPlease upvote or comment this issue if you see this error message.\nNote: the error was labeled with context `DirectAndMut`.\n"
                      "ark_serialize::f_serialize_compressed::<\n &mut alloc::vec::t_Vec<int, alloc::alloc::t_Global>,\n >(&(proj_golden_rs::schnorr_pok::f_response(deref(self))), &mut (buf))"
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_1: Borsh.De.t_BorshDeserialize t_SchnorrPoK =
  {
    ...
    (fun
        ...
        (#[FStar.Tactics.Typeclasses.tcresolve ()] i0: Std.Io.t_Read v_R)
        (reader: v_R)
        (out1: (v_R & Core_models.Result.t_Result t_SchnorrPoK Std.Io.Error.t_Error))
        ->
        true);
    ...
    fun
      ...
      match
        ...
        Core_models.Result.t_Result (Alloc.Vec.t_Vec u8 Alloc.Alloc.t_Global) Std.Io.Error.t_Error
      with
      | Core_models.Result.Result_Ok (buf: Alloc.Vec.t_Vec u8 Alloc.Alloc.t_Global) ->
        (match
            Core_models.Result.impl__map_err #(Ark_ec.Models.Short_weierstrass.Affine.t_Affine
                Ark_bls12_381_.Curves.G1.t_Config)
              #Ark_serialize.Error.t_SerializationError
              #Std.Io.Error.t_Error
              #(Ark_serialize.Error.t_SerializationError -> Std.Io.Error.t_Error)
              (Ark_serialize.f_deserialize_compressed #(Ark_ec.Models.Short_weierstrass.Affine.t_Affine
                  ...
                  #FStar.Tactics.Typeclasses.solve
                  #(t_Slice u8)
                  (buf.[ Core_models.Ops.Range.RangeFull <: Core_models.Ops.Range.t_RangeFull ]
                    <:
                    t_Slice u8)
                <:
            ...
            Core_models.Result.t_Result
              ...
              Std.Io.Error.t_Error
          with
          | Core_models.Result.Result_Ok commitment ->
            let
            (tmp0: v_R),
            (out:
            ...
            (match
              ...
              | Core_models.Result.Result_Ok (buf: Alloc.Vec.t_Vec u8 Alloc.Alloc.t_Global) ->
                (match
                    Core_models.Result.impl__map_err #(Ark_ff.Fields.Models.Fp.t_Fp
                          (Ark_ff.Fields.Models.Fp.Montgomery_backend.t_MontBackend
                              Ark_bls12_381_.Fields.Fr.t_FrConfig (mk_usize 4)) (mk_usize 4))
                      #Ark_serialize.Error.t_SerializationError
                      #Std.Io.Error.t_Error
                      #(Ark_serialize.Error.t_SerializationError -> Std.Io.Error.t_Error)
                      (Ark_serialize.f_deserialize_compressed #(Ark_ff.Fields.Models.Fp.t_Fp
                              (Ark_ff.Fields.Models.Fp.Montgomery_backend.t_MontBackend
                                  Ark_bls12_381_.Fields.Fr.t_FrConfig (mk_usize 4)) (mk_usize 4))
                          #FStar.Tactics.Typeclasses.solve
                          #(t_Slice u8)
                          (buf.[ Core_models.Ops.Range.RangeFull
                              <:
                    ...
                    Core_models.Result.t_Result
                      ...
                      Std.Io.Error.t_Error
                  with
                  | Core_models.Result.Result_Ok response ->
                    let hax_temp_output:Core_models.Result.t_Result t_SchnorrPoK
                      Std.Io.Error.t_Error =
                      Core_models.Result.Result_Ok
                      ({ f_commitment = commitment; f_response = response } <: t_SchnorrPoK)
                      <:
                      Core_models.Result.t_Result t_SchnorrPoK Std.Io.Error.t_Error
                    in
                    reader, hax_temp_output
                    <:
                    (v_R & Core_models.Result.t_Result t_SchnorrPoK Std.Io.Error.t_Error)
                  | Core_models.Result.Result_Err err ->
                    reader,
                    (Core_models.Result.Result_Err err
                      <:
