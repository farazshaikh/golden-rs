...
let impl_13: Core_models.Clone.t_Clone t_Round0Msg =
  { f_clone = (fun x -> x); f_clone_pre = (fun _ -> True); f_clone_post = (fun _ _ -> True) }

[@@ FStar.Tactics.Typeclasses.tcinstance]
assume
val impl_14': Core_models.Fmt.t_Debug t_Round0Msg
...
let impl_15: Core_models.Clone.t_Clone t_ReshareMsg =
  { f_clone = (fun x -> x); f_clone_pre = (fun _ -> True); f_clone_post = (fun _ _ -> True) }

[@@ FStar.Tactics.Typeclasses.tcinstance]
assume
val impl_16': Core_models.Fmt.t_Debug t_ReshareMsg
...
let impl_17: Core_models.Clone.t_Clone t_DkgOutput =
  { f_clone = (fun x -> x); f_clone_pre = (fun _ -> True); f_clone_post = (fun _ _ -> True) }

[@@ FStar.Tactics.Typeclasses.tcinstance]
assume
val impl_18': Core_models.Fmt.t_Debug t_DkgOutput
